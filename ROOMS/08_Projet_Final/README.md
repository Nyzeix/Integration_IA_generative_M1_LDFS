...
Concevoir et réaliser un projet complet qui intègre l'ensemble des compétences acquises : prompt engineering, connexion API, système RAG et analyse des risques.
...
- Une démonstration de session complète
- Une analyse des risques du système
